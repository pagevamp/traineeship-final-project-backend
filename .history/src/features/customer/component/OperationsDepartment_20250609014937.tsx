  ...
  return (
    <div className="w-full bg-[#ffffff] rounded-[25px] flex flex-col pb-2 pt-1 px-4 md:px-8">
      ...
      <div className="flex flex-col items-center gap-7 mt-4">
        <div className="flex flex-wrap gap-6 justify-center md:justify-start items-end w-full">
          <div className="flex flex-col gap-2 w-full max-w-[442px] h-[76px]">
            <Label
              htmlFor="designation"
        ...
        <div className="flex flex-wrap gap-4 justify-center md:justify-start items-center w-full">
          <div
            className="relative w-full max-w-[377px] h-[48px] rounded"
            style={{
