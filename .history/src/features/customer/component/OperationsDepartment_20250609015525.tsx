...
const Operations = () => {
  return (
    <div className="w-full bg-white rounded-[25px] flex flex-col pb-[10px] pt-[5px]">
      <span className="font-primary text-[16px] text-[#1C2B38] text-center ">
        Operational Department
      </span>
      <div className="flex flex-col items-center gap-[27px] mt-[14px] px-[27px]">
        {/* Responsive row - column on small screens */}
        <div className="flex flex-col md:flex-row md:items-end md:gap-[24px] w-full">
          {/* Designation */}
          <div className="flex flex-col gap-2 w-full md:w-[442px] h-[76px]">
            <Label
              htmlFor="designation"
          ...
          {/* Assign To */}
          <div className="flex flex-col gap-2 w-full md:w-[442px] h-[76px] mt-4 md:mt-0">
            <Label
              htmlFor="assign"
              className="text-[16px] font-primary text-[#26203B]"
            >
          ...
          {/* Add Button */}
          <div className="w-full md:w-[85px] h-[35px] rounded-[37px] bg-gradient-to-b from-[#E06518] to-[#E3802A] p-[1px] mt-4 md:mt-auto self-start md:self-end">
