...
import Vendor1 from "./VendorStep1";
import Vendor2 from "./VendorStep2";
import Vendor3 from "./VendorStep3";
import Vendor4 from "./VendorStep4";
import Vendor5 from "./VendorStep5";
...
const VendorCreation = () => {
  ...
  const renderStep = () => {
    const StepComponents = [
      <VendorStep1 key="step-1" />,
      <VendorStep2 key="step-2" />,
      <VendorStep3 key="step-3" />,
      <VendorStep4 key="step-4" />,
      <VendorStep5 key="step-5" />,
    ];

    return StepComponents[currStep - 1] || <VendorStep1 />;
  };
