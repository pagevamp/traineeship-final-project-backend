...
const Operations = () => {
  return (
    <div className="w-full bg-[#ffffff] rounded-[25px] flex-col items-center pb-[10px] pt-[5px]">
      <span className="font-primary text-[16px] text-[#1C2B38] text-center ">
        Operational Department
      </span>
      <div className="flex flex-col gap-[27px] mt-[14px] pl-[27px]">
        <div className="flex flex-row inline items-center gap-[24px]">
