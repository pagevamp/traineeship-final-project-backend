      ...
      {modals.map((modal, index) => {
        ...
        return (
          <Modals
            ...
            className={cn(
              "fixed border-none outline-none left-[50%] top-[50%] z-50 grid w-full max-w-lg max-h-[80vh] translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background shadow-lg duration-200  sm:rounded-lg overflow-y-scroll",
              modal.className
            )}
            overlayClassName={cn(
