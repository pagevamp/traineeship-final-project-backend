...
const Documents = () => {
  ...
  return (
    <div className="flex flex-col w-[1112px] bg-[#ffffff] rounded-[25px] ">
      <div className="flex items-center  gap-4 ">
        ...
        <Button className="w-[125px] h-[115px] bg-[#F1F1F1] rounded-[25px] text-[#1C2B38] ml-[40px] mr-[27px] hover:bg-[#E0E0E0]">
          More
        </Button>
      </div>
    </div>
