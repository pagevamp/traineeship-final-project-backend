    ...
    <div className="flex flex-col gap-[15px]">
      <div className="flex items-end justify-between w-full flex-wrap md:flex-nowrap">
        <div className="flex flex-col w-full md:w-auto">
          {/* Tabs container: horizontally scrollable on small screens */}
          ...
          <TableBody>
            {filteredData.length > 0 ? (
              filteredData.map((item) => (
                ...
                >
                  {/* Wrapper div for responsive flex on small screens */}
                  <div className="flex flex-col md:table-row w-full">
                    <div className="flex flex-wrap md:table-row w-full">
                      <TableCell className="w-1/2 md:w-auto">
                        {item.id}
                      </TableCell>
                      <TableCell className="w-1/2 md:w-auto">
                        {item.date}
